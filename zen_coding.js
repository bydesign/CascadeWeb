...
var zen_coding = (function(){
	...
	/**
	 * ÐŸÑ€Ð¾Ð²ÐµÑ€ÑÐµÑ‚, ÑÐ²Ð»ÑÐµÑ‚ÑÑ Ð»Ð¸ ÑÐ¸Ð¼Ð²Ð¾Ð» Ð´Ð¾Ð¿ÑƒÑÑ‚Ð¸Ð¼Ñ‹Ð¼ Ð² Ð°Ð±Ð±Ñ€ÐµÐ²Ð¸Ð°Ñ‚ÑƒÑ€Ðµ
	 * @param {String} ch
	 * @return {Boolean}
	 */
	...
	/**
	 * Ð’Ð¾Ð·Ð²Ñ€Ð°Ñ‰Ð°ÐµÑ‚ ÑÐ¸Ð¼Ð²Ð¾Ð» Ð¿ÐµÑ€ÐµÐ²Ð¾Ð´Ð° ÑÑ‚Ñ€Ð¾ÐºÐ¸, Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·ÑƒÐµÐ¼Ñ‹Ð¹ Ð² Ñ€ÐµÐ´Ð°ÐºÑ‚Ð¾Ñ€Ðµ
	 * @return {String}
	 */
	function getNewline() {
...
//			lines = text.split(new RegExp('\\r?\\n|\\n\\r|\\r|' + nl));
	...
	/**
	 * ÐžÑ‚Ð±Ð¸Ð²Ð°ÐµÑ‚ Ñ‚ÐµÐºÑÑ‚ Ð¾Ñ‚ÑÑ‚ÑƒÐ¿Ð°Ð¼Ð¸
	 * @param {String} text Ð¢ÐµÐºÑÑ‚, ÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ð¹ Ð½ÑƒÐ¶Ð½Ð¾ Ð¾Ñ‚Ð±Ð¸Ñ‚ÑŒ
	 * @param {String|Number} pad ÐšÐ¾Ð»Ð¸Ñ‡ÐµÑÑ‚Ð²Ð¾ Ð¾Ñ‚ÑÑ‚ÑƒÐ¿Ð¾Ð² Ð¸Ð»Ð¸ ÑÐ°Ð¼ Ð¾Ñ‚ÑÑ‚ÑƒÐ¿
	 * @return {String}
	 */
	...
	/**
	 * ÐŸÑ€Ð¾Ð²ÐµÑ€ÑÐµÑ‚, Ð·Ð°ÐºÐ°Ñ‡Ð¸Ð²Ð°ÐµÑ‚ÑÑ Ð»Ð¸ ÑÑ‚Ñ€Ð¾ÐºÐ° Ð¿Ð¾Ð»Ð½Ð¾Ñ†ÐµÐ½Ð½Ñ‹Ð¼ Ñ‚ÑÐ³Ð¾Ð¼. Ð’ Ð¾ÑÐ½Ð¾Ð²Ð½Ð¾Ð¼ 
	 * Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·ÑƒÐµÑ‚ÑÑ Ð´Ð»Ñ Ð¿Ñ€Ð¾Ð²ÐµÑ€ÐºÐ¸ Ð¿Ñ€Ð¸Ð½Ð°Ð´Ð»ÐµÐ¶Ð½Ð¾ÑÑ‚Ð¸ ÑÐ¸Ð¼Ð²Ð¾Ð»Ð° '>' Ð°Ð±Ð±Ñ€ÐµÐ²Ð¸Ð°Ñ‚ÑƒÑ€Ðµ 
	 * Ð¸Ð»Ð¸ Ñ‚ÑÐ³Ñƒ
	 * @param {String} str
	 * @return {Boolean}
	 */
	 ...
	 * Ð¢ÑÐ³
	 * @class
	 * @param {String} name Ð˜Ð¼Ñ Ñ‚ÑÐ³Ð°
	 * @param {Number} count Ð¡ÐºÐ¾Ð»ÑŒÐºÐ¾ Ñ€Ð°Ð· Ð²Ñ‹Ð²ÐµÑÑ‚Ð¸ Ñ‚ÑÐ³ (Ð¿Ð¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ: 1)
	 * @param {String} type Ð¢Ð¸Ð¿ Ñ‚ÑÐ³Ð° (html, xml)
	 */
	...
	Tag.prototype = {
		/**
		 * Ð”Ð¾Ð±Ð°Ð²Ð»ÑÐµÑ‚ Ð½Ð¾Ð²Ð¾Ð³Ð¾ Ð¿Ð¾Ñ‚Ð¾Ð¼ÐºÐ°
		 * @param {Tag} tag
		 */
		...
		/**
		 * Ð”Ð¾Ð±Ð°Ð²Ð»ÑÐµÑ‚ Ð°Ñ‚Ñ€Ð¸Ð±ÑƒÑ‚
		 * @param {String} name ÐÐ°Ð·Ð²Ð°Ð½Ð¸Ðµ Ð°Ñ‚Ñ€Ð¸Ð±ÑƒÑ‚Ð°
		 * @param {String} value Ð—Ð½Ð°Ñ‡ÐµÐ½Ð¸Ðµ Ð°Ñ‚Ñ€Ð¸Ð±ÑƒÑ‚Ð°
		 */
		...
		/**
		 * ÐŸÑ€Ð¾Ð²ÐµÑ€ÑÐµÑ‚, ÑÐ²Ð»ÑÐµÑ‚ÑÑ Ð»Ð¸ Ñ‚ÐµÐºÑƒÑ‰Ð¸Ð¹ ÑÐ»ÐµÐ¼ÐµÐ½Ñ‚ Ð¿ÑƒÑÑ‚Ñ‹Ð¼
		 * @return {Boolean}
		 */
		isEmpty: function() {
		...
		/**
		 * ÐŸÑ€Ð¾Ð²ÐµÑ€ÑÐµÑ‚, ÑÐ²Ð»ÑÐµÑ‚ÑÑ Ð»Ð¸ Ñ‚ÐµÐºÑƒÑ‰Ð¸Ð¹ ÑÐ»ÐµÐ¼ÐµÐ½Ñ‚ ÑÑ‚Ñ€Ð¾Ñ‡Ð½Ñ‹Ð¼
		 * @return {Boolean}
		 */
		isInline: function() {
		...
		/**
		 * ÐŸÑ€Ð¾Ð²ÐµÑ€ÑÐµÑ‚, ÑÐ²Ð»ÑÐµÑ‚ÑÑ Ð»Ð¸ Ñ‚ÐµÐºÑƒÑ‰Ð¸Ð¹ ÑÐ»ÐµÐ¼ÐµÐ½Ñ‚ Ð±Ð»Ð¾Ñ‡Ð½Ñ‹Ð¼
		 * @return {Boolean}
		 */
		isBlock: function() {
		...
		/**
		 * ÐŸÑ€Ð¾Ð²ÐµÑ€ÑÐµÑ‚, ÐµÑÑ‚ÑŒ Ð»Ð¸ Ð±Ð»Ð¾Ñ‡Ð½Ñ‹Ðµ Ð¿Ð¾Ñ‚Ð¾Ð¼ÐºÐ¸ Ñƒ Ñ‚ÐµÐºÑƒÑ‰ÐµÐ³Ð¾ Ñ‚ÑÐ³Ð°. 
		 * Ð˜ÑÐ¿Ð¾Ð»ÑŒÐ·ÑƒÐµÑ‚ÑÑ Ð´Ð»Ñ Ñ„Ð¾Ñ€Ð¼Ð°Ñ‚Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ñ
		 * @return {Boolean}
		 */
...
//					
	...
	Snippet.prototype = {
		...
		toString: function(profile_name) {
			...
			// Ð²Ñ‹Ð²Ð¾Ð´Ð¸Ð¼ Ñ‚ÑÐ³ Ð½ÑƒÐ¶Ð½Ð¾Ðµ ÐºÐ¾Ð»Ð¸Ñ‡ÐµÑÑ‚Ð²Ð¾ Ñ€Ð°Ð·
			for (var i = 0; i < this.count; i++) 
	...
	return {
		...
		extractAbbreviation: function(str) {
			...
			while (true) {
				cur_offset--;
				if (cur_offset < 0) {
					// Ð´Ð¾ÑˆÐ»Ð¸ Ð´Ð¾ Ð½Ð°Ñ‡Ð°Ð»Ð° ÑÑ‚Ñ€Ð¾ÐºÐ¸
					start_index = 0;
					break;
				}
			...
			if (start_index != -1) 
				// Ñ‡Ñ‚Ð¾-Ñ‚Ð¾ Ð½Ð°ÑˆÐ»Ð¸, Ð²Ð¾Ð·Ð²Ñ€Ð°Ñ‰Ð°ÐµÐ¼ Ð°Ð±Ð±Ñ€ÐµÐ²Ð¸Ð°Ñ‚ÑƒÑ€Ñƒ
		...
		parseIntoTree: function(abbr, type) {
			...
			// if not â€” abbreviation wasn't valid 
